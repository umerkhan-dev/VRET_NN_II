...
namespace NNMarkII
{
    class NeuralNetwork
    {
        ...
        public NeuralNetwork(int[] layer)
        {
            ...
            {
                layers[i] = new Layer(layer[i], layer[i+1], i);
            }
        }
        ...
        public class Layer
        {
            ...
            public Layer(int numberOfInputs, int numberOfOuputs, int LNumber)
            {
                this.layerNumber = LNumber;
            ...
            {
                StreamWriter writer = new StreamWriter(Environment.CurrentDirectory + @"\Assets\Weights" + @"\" + this.layerNumber);
                for (int i = 0; i < numberOfOuputs; i++)
                {
                    for (int j = 0; j < numberOfInputs; j++)
                    {
            ...
            //---------------------------------------------------------------------------------------
            //public void WriteWeightsToArray()
            //{
            //    StreamWriter writer = new StreamWriter(Environment.CurrentDirectory + @"\Assets\Weights.cs", true);
            ...
            //            if (i != numberOfOuputs - 1 && j != numberOfInputs - 1)
            //            {
            //                writer.Write(@", ");
            //            }
            //        }
            ...
            {
                StreamReader reader = new StreamReader(Environment.CurrentDirectory + @"\Assets\Weights" + @"\" + this.layerNumber);
                for (int i = 0; i < numberOfOuputs; i++)
                {
                    for (int j = 0; j < numberOfInputs; j++)
                    {
            ...
            //-----------------------------------------------------------------------------------------
            public void _ReadWeights(float[] weight)
            {

                int k = 0;
                for (int i = 0; i<numberOfOuputs; i++)
			    {
                    for (int j = 0; j < numberOfInputs; j++,k++)
                    {
                        weights[i, j] = weight[k];
